...
export const SET_CLUSTER_NAMESPACES = 'SET_CLUSTER_NAMESPACES';
export const SET_CLUSTER_SERVICES = 'SET_CLUSTER_SERVICES';
export const SET_CLUSTER_NODES = 'SET_CLUSTER_NODES';
