...
export const fetchClusterCpuUsage = async () => {
  const data = await fetch(
    'http://localhost:30000/api/v1/query?query=(1 - sum by (instance)(increase(node_cpu_seconds_total{mode="idle"}[5m])) / sum by (instance)(increase(node_cpu_seconds_total[5m])))*100',
    {
      method: 'GET',
      headers: {
...
export const fetchTotalNodes = async () => {
  const data = await fetch(
    'http://localhost:30000/api/v1/query?query=count(kube_node_created)',
    {
      method: 'GET',
      headers: {
        Accept: 'application/json',
...
export const fetchTotalDeployments = async () => {
  const data = await fetch(
    'http://localhost:30000/api/v1/query?query=count(kube_deployment_created)',
    {
      method: 'GET',
      headers: {
        Accept: 'application/json',
...
export const fetchTotalPods = async () => {
  const data = await fetch(
    'http://localhost:30000/api/v1/query?query=count(kube_pod_created)',
    {
      method: 'GET',
      headers: {
        Accept: 'application/json',
...
export const fetchTotalServices = async () => {
  const data = await fetch(
    'http://localhost:30000/api/v1/query?query=count(kube_service_created)',
    {
      method: 'GET',
      headers: {
        Accept: 'application/json',
